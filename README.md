...
## Try It Out!
Check out the releases page to download the latest release. The program was compiled with the GNU G++ compiler and currently, it won't run on your machine if your machine is not running on **Windows**.
